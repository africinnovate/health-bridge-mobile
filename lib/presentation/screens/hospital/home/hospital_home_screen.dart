                    ...
                    Padding(
                      ...
                      child: Consumer<HospitalProvider>(
                        builder: (context, hospitalProvider, _) {
                          final activeCount = hospitalProvider
                                  .dashboardStats?.activeBloodRequests ??
                              0;
                          final urgentCount = hospitalProvider
                                  .dashboardStats?.urgentRequestsNearby ??
                              0;
                          ...
                          return Row(
                            children: [
                              ...
                              Expanded(
                                child: _cardView(
                                  count:
                                      appointmentCount, // TODO - change to inventory count
                                  period: selectedPeriod,
                                  onPeriodTap: () {
                                    _showPeriodMenu();
                                  },
                                  onTap: () {
                                    context
                                        .goNextScreen(AppRoutes.bloodInventory);
                                  },
                                  fromInventory: true,
                                ),
                              ),
            ...
            child: Column(
              ...
              children: [
                ...
                Consumer<HospitalProvider>(
                  builder: (context, hospitalProvider, _) {
                    final hospitalName =
                        hospitalProvider.hospitalProfile?.name ?? 'Hospital';
                    return CustomText(
                      text: hospitalName,
                      size: 16,
                      shouldBold: true,
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Icon(
                  ...
                  color: fromInventory ? Colors.grey : AppColors.green,
                ),
                InkWell(
                  onTap: onPeriodTap,
            ...
            RichText(
              text: TextSpan(
                children: [
                  ...
                  TextSpan(
                    text: fromInventory ? 'inventory' : 'appointments',
                    style: const TextStyle(
                      fontSize: 16,
            ...
            /// Subtitle
            Text(
              fromInventory ? 'Inventory records' : 'Upcoming Donations',
              style: TextStyle(
                fontSize: 14,
                fontWeight: FontWeight.w600,
              ),
